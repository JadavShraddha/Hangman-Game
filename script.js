window.onload = function () {
    ...
    var celebrationSong = document.getElementById("celebrationSong");
    ...
    comments = function () {
        ...
        for (var i = 0; i < geusses.length; i++) {
          if (counter + space === geusses.length) {
            ...
            playCelebrationSong();
            displayCelebrationGif();
          }
        }
      }
      
      function displayCelebrationGif() {
        // Create an image element for the GIF
        var celebrationGif = document.createElement('img');
        celebrationGif.src = 'https://media.tenor.com/GeqD2VYSMvYAAAAi/konfetti-party.gif';
        ...
        celebrationGif.style.zIndex = '9999';
    ...
    function playCelebrationSong() {
        stopCelebrationSong(); // Stop the celebration song if it's already playing
    ...
    document.getElementById('reset').onclick = function() {
        ...
        stopCelebrationSong(); // Stop the celebration song
        play();
      }
